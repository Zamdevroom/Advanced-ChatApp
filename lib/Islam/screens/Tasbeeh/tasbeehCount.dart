...
class _CounterScreenState extends State<CounterScreen> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('Tasbeeh', style: TextStyle(fontFamily: 'Poppins', fontWeight: FontWeight.w900, color: AppColors.primaryColor)),
      ),
                            ...
                            child: Container(
                              ...
                              child: Center(
                                child: Text(
                                  '$_counter',
                                  style: TextStyle(
                                    fontSize: _counter < 1000 ? size.height / 14 : size.height / 24,
                                    fontWeight: FontWeight.bold,
